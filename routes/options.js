...
const { getOnlyDemoCustomers, getTeacherSlots,getOptionByCustomer,getOptionsByTeacherId, postAnOption, getOptions,getAnOption, updateAnOption,deleteAnOption } = require("../controllers/options");
